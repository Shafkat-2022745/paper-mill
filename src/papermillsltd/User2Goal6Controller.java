 ...
 * @author Shanto
 */
public class User2Goal6Controller implements Initializable {
    ...
    private void saveOnClick(ActionEvent event) {
        {
    String data = "C 1:"+water.getText() + "," + "B 1:"+waste.getText() + "," + "C 2:" + safety.getText() + "," + "B 2:"+energy.getText() + "\n";
    
    try {
        // Create a FileWriter object to write to the file
        FileWriter writer = new FileWriter("C&B.txt", true);
