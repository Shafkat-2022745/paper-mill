 ...
 * @author Shanto
 */
public class User2Goal3Controller implements Initializable {
    ...
    private void Add(ActionEvent event) {
        String data = "Name:"+name.getText() + "    " + "Development Needed:"+share.getText();
    
    try {
        // Create a FileWriter object to write to the file
        FileWriter writer = new FileWriter("DevelopmentNeeded.txt", true);
    ...
    private void Show(ActionEvent event) {
      try {
        ...
        FileReader reader = new FileReader("DevelopmentNeeded.txt");
