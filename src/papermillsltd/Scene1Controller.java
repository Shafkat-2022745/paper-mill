...
public class Scene1Controller implements Initializable {
    ...
    @FXML
    private void ExMnT(ActionEvent event) throws IOException {
        Parent twoViewParent = FXMLLoader.load(getClass().getResource("scene2.fxml"));
    ...
    @FXML
    private void QuConMS(ActionEvent event) throws IOException {
        Parent twoViewParent = FXMLLoader.load(getClass().getResource("scene3.fxml"));
        Scene twoViewScene = new Scene(twoViewParent);
